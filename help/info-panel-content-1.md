...
1. Haga clic en **InfoPanel Setup** para desplegar el panel.
...
1. Haga clic en **Cargar** para cargar el contenido del panel de información, según los valores de rollover_key, a s7info.
1. En el cuadro de diálogo Carga de S7Info, busque el archivo que desea utilizar y, a continuación, haga clic en **Cargar**.
...
1. Haga doble clic en el conjunto de imágenes para abrirlo en la vista de detalles.
1. Haga clic en **InfoPanel Datafeed** para desplegar el panel.
1. En el campo de texto Ubicación del archivo CSV alojado de forma externa (HTTP), introduzca la URL del archivo CSV.
1. (Opcional) En los campos Programar actualización , especifique una hora para actualizar el contenido y haga clic en **Agregar**.

   Puede seleccionar varios tiempos de actualización. Cada tiempo de actualización aparece en el cuadro Tiempos de actualización. Para quitar una hora programada, selecciónela y haga clic en **Eliminar**.
