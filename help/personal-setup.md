...
description: nulo
seo-description: Todos los usuarios pueden cambiar la configuración en la pantalla Ajustes personales de Dynamic Media Classic.
...
1. En la página Ajustes personales de Dynamic Media Classic, en Complemento de Illustrator para impresión virtual, haga clic en **Descargar ahora** para descargar el archivo **Complemento de Illustrator para impresión virtual.zip**.
...
* **Contraseña**
* **Nueva contraseña**
   * Introduzca una contraseña nueva y válida. La contraseña debe cumplir los siguientes requisitos:
