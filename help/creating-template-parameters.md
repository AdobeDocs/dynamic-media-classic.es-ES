...
1. Select **[!UICONTROL Cerrar]** para salir de la pantalla Parámetros.
...
1. Seleccione el **[!UICONTROL Activado]** junto al nombre del atributo text (textAttr).
1. Seleccione el **[!UICONTROL Texto]** en la pantalla Parámetros.
1. Select **[!UICONTROL Agregar parámetro]**. Aparecerá un nombre de parámetro predeterminado. Si quiere modificar el nombre, selecciónelo y sobrescríbalo. La cadena de texto actual se convierte en el nuevo nombre del parámetro.
1. Select **[!UICONTROL Cerrar]** para cerrar la página Parámetros.
