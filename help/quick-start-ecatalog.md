...
![El catálogo electrónico tal como lo ven los usuarios. A) Página de apertura del catálogo electrónico. B)Catálogo electrónico dirigido a la página 2.](/help/assets/ec_cat_viewer_popup.png)
...
Consulte [Administración del contenido del panel de información en catálogos electrónicos](/help/info-panel-content-ecatalog.md).
