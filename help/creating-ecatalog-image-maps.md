...
1. En el área del mapa de imagen, dibuje un mapa de imagen rectangular o poligonal (con varios lados):
   ...
   * **Mapa rectangular** - Seleccione la herramienta Rectángulo Image Map y arrastre la página para crear el rectángulo.

   * **Mapa poligonal** - Seleccione la herramienta Mapa de imagen polígono y, a continuación, seleccione tantas veces como sea necesario alrededor del perímetro de la imagen. A medida que selecciona, Adobe Dynamic Media Classic dibuja los bordes del mapa de imagen.
...
1. (Opcional) En la lista Mapa de imágenes, en la [!UICONTROL Nombre] , puede introducir un nombre nuevo para el mapa de imagen. No incluya espacios en blanco en el nombre.
...
1. (Opcional) En la lista desplegable Mostrar , seleccione **[!UICONTROL Texto alternativo]** y, a continuación, introduzca el texto que desea que vean los usuarios en pantalla cuando desplacen sus punteros por el mapa de imagen.
1. (Opcional) En la lista desplegable Mostrar , seleccione **[!UICONTROL Otras acciones]** e introduzca un atributo para crear un déclencheur de una acción de desenfoque o enfoque cuando los usuarios muevan sus punteros sobre un mapa de imagen.
...
1. (Opcional) Seleccione **[!UICONTROL Vista previa]** para ver el catálogo electrónico con el ajuste preestablecido predeterminado del visor de catálogos electrónicos.
...
Si lo desea, también puede mostrar información sobre herramientas cuando los clientes muevan sus punteros sobre el mapa de imagen para que sepan lo que están seleccionando.
...
1. (Opcional) En el panel de la lista Mapa de imágenes, debajo de **[!UICONTROL Información del objeto]** , introduzca el texto que desea que vean los visualizadores en pantalla cuando desplacen el puntero sobre el mapa de imagen.
1. Select **[!UICONTROL Guardar]**.
...
* **Ajustar la posición** - Seleccione la herramienta Panorámica y mueva el puntero cerca pero no sobre el borde del mapa. Cuando el puntero se convierta en una flecha con cuatro puntas, arrastre el mapa completo de imagen a una nueva ubicación.
...
* **Eliminación de mapas de imagen** - Seleccione la herramienta Panorámica, seleccione el mapa de imagen para seleccionarlo y, a continuación, seleccione **[!UICONTROL Eliminar]**.
   ...
   Para eliminar todos los mapas de imagen de un catálogo electrónico, seleccione la opción **[!UICONTROL Ordenar páginas]** y, a continuación, seleccione **[!UICONTROL Borrar asignaciones]**.
...
* **Copia de mapas de imagen a otras páginas** - Seleccionar **[!UICONTROL Copiar asignaciones a]** (asegúrese de que está en la ficha Páginas de mapa ). En la pantalla Seleccionar imágenes , seleccione la página o páginas donde desee copiar los mapas de imagen y, a continuación, seleccione **[!UICONTROL Select]**.
...
1. Si hay errores de claves de sustitución, seleccione el error en la variable **[!UICONTROL Error Rollover_Key]** para ver qué debe cambiar en la hoja de cálculo para corregir el error. Puede seleccionar y copiar el texto de este mensaje, y pegarlo en la hoja de cálculo.
1. Select **[!UICONTROL Vista previa]** para examinar una página en el visor de catálogos electrónicos; seleccione la X para cerrar la pantalla Resumen y volver a la pantalla Páginas de mapa o seleccione **[!UICONTROL Cerrar]** para volver a Examinar.
...
1. Select **[!UICONTROL Importar datos de mapa]**.
...
1. Seleccione el catálogo electrónico con los mapas de imagen que desea copiar y seleccione el rollover del catálogo electrónico **[!UICONTROL Editar]** botón.
1. En la ficha Ordenar páginas, seleccione **[!UICONTROL Copiar asignaciones]**.
1. En el cuadro de diálogo Seleccionar recurso, seleccione el catálogo electrónico en el que desea copiar los mapas de imagen y, a continuación, seleccione **[!UICONTROL Select]**.

Adobe Dynamic Media Classic muestra un mensaje de advertencia si el catálogo electrónico de destino (el catálogo electrónico al que copia los mapas de imagen) tiene un número diferente de páginas o imágenes de un tamaño diferente. Select **[!UICONTROL Continuar]** para copiar los mapas de imagen a pesar de la advertencia.
