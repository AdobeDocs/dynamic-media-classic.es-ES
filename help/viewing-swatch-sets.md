...
1. Realice una de las siguientes acciones:
   ...
   * Para crear un ajuste preestablecido, seleccione **[!UICONTROL Agregar]**. En el cuadro de diálogo Agregar ajuste preestablecido de visualizador, en la lista desplegable Visualizador, elija **[!UICONTROL Visor de conjuntos de muestras]** y, a continuación, seleccione **[!UICONTROL Agregar]**.
...
1. En el panel Biblioteca de recursos del lado izquierdo, en la **[!UICONTROL Show]** lista desplegable, seleccione un tipo de recurso basado en conjuntos de muestras como **[!UICONTROL Conjunto de muestras]**.
...
1. Select **[!UICONTROL Cerrar]** para volver a la página Recursos.
