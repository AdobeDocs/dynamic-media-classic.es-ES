...
>[!NOTE]
>
>También puede acceder a la lista con las publicaciones recientes desde la página Actividad reciente. Select **[!UICONTROL Reciente]** en la barra de navegación global.

## Acerca de la página Trabajos {#about-the-jobs-page}

Select **[!UICONTROL Trabajos]** en la barra de navegación global para que se abra la página Trabajos . De forma predeterminada, la lista de trabajos empieza por los trabajos más recientes.
...
* **[!UICONTROL Destino]** : para los trabajos de carga, el nombre de la empresa y la carpeta a la que se cargaron los archivos. Esta categoría no se aplica a los trabajos de publicación.

* **[!UICONTROL Presentado por]** - Enumera quién cargó los recursos.

>[!NOTE]
>
>Puede cancelar los trabajos de publicación y carga en curso seleccionando la opción **[!UICONTROL Cancelar]** situado junto a la barra de progreso.
...
* **[!UICONTROL Intervalo de fechas]** - Seleccione el **[!UICONTROL Intervalo de fechas]** y elija una opción para reducir la lista de trabajos a la fecha actual, la semana anterior o el mes anterior. Select **[!UICONTROL Intervalo de fechas personalizado]** y, a continuación, introduzca un intervalo de fechas específico.

* **[!UICONTROL Tipo de trabajo]** - Seleccione el **[!UICONTROL Tipo de trabajo]** y seleccione **[!UICONTROL Publicación]** o **[!UICONTROL Cargar]** para limitar la lista a trabajos publicados o de carga. Select **[!UICONTROL Todo]** para ver ambos tipos de trabajos.

* **[!UICONTROL Show]** - Vaya a **[!UICONTROL Show]** > **[!UICONTROL Mis trabajos]** o **[!UICONTROL Show]** > **[!UICONTROL Todos los trabajos]** para reducir la lista a los trabajos que ha solicitado o a los que han solicitado las personas de su empresa.

## Ver, copiar o imprimir un informe Detalles del trabajo {#viewing-copying-or-printing-a-job-details-report}

Haga doble clic en el nombre de un informe en la página Trabajos para que se abra la página Detalles del trabajo . Esta página ofrece un informe resumido acerca de los archivos del trabajo. Select **[!UICONTROL Ver detalle]** para que pueda ver el Adobe Dynamic Media Classic ID de una entrada, la ruta de destino y la información de estado. Si ha cargado un PDF o un archivo PostScript que requiere fuentes que no están disponibles en Adobe Dynamic Media Classic, el informe enumera las fuentes que faltan.
...
Seleccione el botón Trabajos en la barra de navegación global y, en la página Trabajos, seleccione la opción **[!UICONTROL Programado]** para editar y eliminar trabajos recurrentes.

>[!NOTE]
>
>Puede filtrar la lista de trabajos en el **[!UICONTROL Programado]** con el **[!UICONTROL Tipo de trabajo]** y **[!UICONTROL Show]** menús. Seleccione un tipo de trabajo para que pueda limitar la lista para publicar trabajos de un tipo específico. Seleccione un **[!UICONTROL Show]** si desea mostrar los trabajos que ha creado o los trabajos creados por todos los miembros de la empresa.
...
* **Editar un trabajo recurrente** - Seleccione el **[!UICONTROL Editar]** e introduzca información de programación en el cuadro de diálogo Editar trabajo programado. Si desea que el trabajo se repita en el intervalo que elija, vaya a **[!UICONTROL Repetir]** > **[!UICONTROL Personalizado]**.
...
* **Poner en pausa (y reanudar) un trabajo recurrente** - En la columna Activo, anule la selección de una casilla de verificación para pausar un trabajo; seleccione una casilla de verificación para reanudar un trabajo que se haya pausado.
...
| Día del mes | 1-31 | No puede especificar un valor numérico tanto para &quot;día del mes&quot; como para &quot;día de la semana&quot;. Uno de estos campos debe utilizar una `?` carácter comodín. | `, - * / ? L C` |
| Mes | 1-12 o Ene, Feb, Mar, Abr, Mayo, Jun, Julio, Ago, Sep, Sep, Oct, Nov, Dic | Los valores distinguen entre mayúsculas y minúsculas. | `, - * /` |
| Día de la semana | lun, mar, mié, jue, vie, sáb, dom | Los valores distinguen entre mayúsculas y minúsculas. No puede especificar un valor numérico tanto para &quot;día del mes&quot; como para &quot;día de la semana&quot;. Uno de estos campos debe utilizar una `?` carácter comodín. | `, - * / ? L C #` |
...
| `L` | L mayúscula | Último &quot;día del mes&quot; o &quot;día de la semana&quot; (solo disponible para estos campos). Por ejemplo, si el mes es enero y se escribe el valor L en el campo &quot;día del mes&quot; el trabajo se programa para el 31 de enero. En el campo &quot;día de la semana&quot;, puede introducir este carácter si desea programar el trabajo para que se ejecute los sábados. Puede utilizarlo con un número (por ejemplo, `6L`) para especificar el último viernes del mes. No especifique `L` con los caracteres comodín de coma o guión. |
| `#` | Almohadilla | Número del día de la semana dentro del mes (solo disponible para el campo &quot;día de la semana&quot;). Por ejemplo, `6#3` en el campo &quot;día de la semana&quot; especifica el tercer viernes del mes. La variable `6` indica &quot;viernes&quot; (sexto día de la semana) y `3` denota la tercera incidencia del mes. |
| `C` | # C mayúscula | Primer &quot;día del mes&quot; o &quot;día de la semana&quot; en el calendario (solo disponible para estos campos). Por ejemplo, si se especifica un valor de `1C` para &quot;día del mes&quot;, programa el primer día del calendario que se produce en o después del quinto día. Para el campo &quot;día de la semana&quot;, especifique `1C` programa el primer día del calendario que se produce el domingo o después de él |
