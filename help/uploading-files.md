...
Esta tabla lista los formatos de archivo de recursos que admite Dynamic Media Classic. Para obtener información sobre los archivos Camera Raw admitidos, consulte [www.adobe.com/go/learn_s7_cameraraw_en](https://www.adobe.com/go/learn_s7_cameraraw_en).
...
| Vídeos | Dynamic Media Classic admite archivos de vídeo guardados en formato OGV y MP4. Puede transcodificar los archivos al formato MP4 al cargarlos.Consulte [Formatos de archivo de recurso admitidos](#supported-static-file-formats). |
...
**Basado en la marcaPara los fabricantes con varias líneas de marca y los minoristas que comercializan otras marcas desde otras compañías, separe los archivos en carpetas de productos con nombres para distintas marcas.** 

**Las carpetas** basadas en proyectos se organizan según la fecha de implementación/colocación o el nombre del proyecto. Es el método favorito de los clientes que producen principalmente catálogos electrónicos.

**Reflejo de la** jerarquía de carpetas del sitio webEsta estructura refleja la estructura de carpetas del sitio web, con las carpetas denominadas, por ejemplo, para categorías de productos.

## Acerca de la carga de archivos {#uploading-your-files}

Puede cargar archivos individuales desde el escritorio o cargar carpetas enteras mediante FTP. Si desea cargar más de 100 MB de archivos o carpetas y subcarpetas enteras, seleccione la ficha **VIA FTP**.
...
### Carga de archivos mediante la ficha DESKTOP DESDE {#upload-files-using-sps-desktop-application}

La aplicación Dynamic Media Classic Desktop permite cargar archivos y carpetas arrastrándolos.

1. En la aplicación Dynamic Media Classic Desktop, en la barra de navegación global, haga clic en **Cargar**.
1. En la página Cargar, haga clic en la ficha **DESKTOP**.
...
1. En la parte derecha de la página Cargar, en el área **Elija el destino de la carpeta**, navegue a la carpeta de destino donde desee agregar los archivos o carpetas cargados.
...
1. (Opcional) Cerca de la parte inferior de la página Cargar, seleccione **Publicar después de cargar** si desea publicar automáticamente los recursos que cargue.
...
El nombre de esta opción puede ser diferente, según la configuración de **Ajustes de aplicación > Configuración general > Cargar a la aplicación > Sobrescribir imágenes**.
1. Cerca de la esquina inferior derecha de la página Cargar, haga clic en **Opciones de trabajo** y especifique las opciones que desee.
...
1. En la página Cargar, haga clic en la ficha **VIA FTP**.
1. En la parte izquierda de la página Cargar, en el área **Elija la carpeta FTP para la carga**, elija una carpeta FTP desde la cual cargar los archivos.
1. En la parte derecha de la página Cargar, en el área **Elija Adobe Dynamic Media Folder Destination**, elija una carpeta de destino en Dynamic Media Classic.
1. (Opcional) Cerca de la parte inferior de la página Cargar, en el campo **Nombre del trabajo**, especifique el nuevo nombre del trabajo de carga. O bien, puede utilizar el nombre predeterminado generado por el sistema que proporciona Dynamic Media Classic. El trabajo, junto con otros de carga y publicación, se grabará en la página Trabajos, donde puede comprobar el estado de los trabajos. Consulte [Comprobación de archivos de trabajo](checking-job-files.md#checking_job_files).
1. (Opcional) Cerca de la parte inferior de la página de carga, seleccione **Publicar después de la carga** si desea publicar automáticamente los recursos que cargue.
Al publicar archivos, se envían a servidores interactivos. Las URL para estos archivos se pueden utilizar en sitios Web y aplicaciones externas. Tenga en cuenta que esta misma opción también está disponible en el cuadro de diálogo Opciones de trabajo.
1. (Opcional) Cerca de la parte inferior de la página Cargar, seleccione **Sobrescribir en cualquier carpeta, el mismo nombre de recurso base independientemente de la extensión** si desea que los archivos que cargue reemplacen los archivos existentes con los mismos nombres. Tenga en cuenta que esta misma opción también está disponible en el cuadro de diálogo Opciones de trabajo.
El nombre de esta opción puede ser diferente, según la configuración de **Ajustes de aplicación > Configuración general > Cargar a la aplicación > Sobrescribir imágenes**.
1. (Opcional; sólo está disponible si ha hecho clic en la ficha **VIA FTP**) Cerca de la parte inferior de la página de carga, seleccione **Descomprimir archivos comprimidos o de barra en la carga** si desea extraer automáticamente todos los archivos del archivo ZIP o TAR cargado. Tenga en cuenta que esta misma opción también está disponible en el cuadro de diálogo Opciones de trabajo.
1. Cerca de la esquina inferior derecha de la página Cargar, haga clic en **Opciones de trabajo** y especifique las opciones que desee.
...
* **TRABAJO** — Haga clic en  **** TRABAJO para elegir las opciones que afectan a todo el trabajo de carga.
   ...
   Tenga en cuenta que también puede elegir *opciones predeterminadas* para cargar trabajos mediante el cuadro de diálogo **Opciones de carga predeterminadas** en Configuración general. Haga clic en **Ajustes > Ajustes de aplicación > Configuración general > Opciones de carga predeterminadas** y defina las opciones predeterminadas que desee.

   * **Cuándo** — La opción  **** Cuándo solo está disponible si ha seleccionado la  **ficha** FTP.
      ...
      * **Recurrente** — Especifique un trabajo de carga que se ejecute diariamente, semanalmente o mensualmente. O bien, personalice el trabajo de carga según sus propias especificaciones.
         * **Diario** — Defina la hora a la que desea que se ejecute el trabajo todos los días. Si desea que el trabajo se ejecute solamente de lunes a viernes, seleccione **Sólo días de semana**.
...
Seleccione esta opción si desea extraer automáticamente todos los archivos del archivo ZIP o TAR cargado. Tenga en cuenta que esta misma opción también está disponible en el cuadro de diálogo Opciones de trabajo.
   ...
   * **Incluir subcarpetas** — Solo está disponible si ha seleccionado la  **ficha** FTP de VIA.
...
* **OPTIONS**  de Photoshop: Puede crear plantillas a partir de archivos Adobe® Photoshop®, mantener las capas, especificar cómo se llaman las capas, extraer texto y especificar cómo se anclan las imágenes en las plantillas.
...
* **OPTIONS**  de Illustrator: Puede rasterizar archivos Adobe Illustrator®, mantener fondos transparentes, elegir una resolución y elegir un espacio de color.
Consulte [Uso de archivos de PostScript e Illustrator](postscript-illustrator-files.md#working_with_postscript_and_illustrator_files).
...
1. Haga clic en **Cargar** y, a continuación, haga clic en la ficha **VIA FTP**.
