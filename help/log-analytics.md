...
1. Cerca de la esquina superior derecha de la página de Dynamic Media Classic de Adobe, vaya a **[!UICONTROL Configuración]** > **[!UICONTROL Configuración de la aplicación]**.
...
1. En el menú desplegable **[!UICONTROL Grupo de informes]**, elija un grupo de informes y, a continuación, seleccione **[!UICONTROL Aceptar]**.
