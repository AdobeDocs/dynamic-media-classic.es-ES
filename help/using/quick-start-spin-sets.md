...
## 6. Publish es un conjunto de giros
...
Para publicar un conjunto de giros, márquelo para su publicación seleccionando el icono **[!UICONTROL Marcar para Publish]** junto a su nombre en el panel Examinar. En la barra de navegación global, seleccione **[!UICONTROL Publish]** para iniciar una publicación. En la página Publicación, seleccione **[!UICONTROL Enviar Publish]**.
