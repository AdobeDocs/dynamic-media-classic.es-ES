...
* **Exportar datos del informe**: en la vista de datos, ordene y organice los datos según sea necesario. A continuación, abra el menú **[!UICONTROL Exportar]** y elija un formato: **[!UICONTROL Delimitado por tabulaciones]**, **[!UICONTROL Separado por comas]** o **[!UICONTROL HTML con formato]**. Los datos se copian en el Portapapeles en el formato que elija. Ahora puede pegarlos en una hoja de cálculo o en una aplicación.
