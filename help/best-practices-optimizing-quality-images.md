...
Documentación técnica sobre prácticas recomendadas [Enfoque de imágenes en Adobe Dynamic Media Classic y en el servidor de imágenes](/help/assets/s7_sharpening_images.pdf).
...
* Máscara de enfoque ( `&op_USM`) - Máscara de enfoque es un filtro estándar de la industria para el enfoque. La práctica recomendada es enfocar imágenes con la máscara de enfoque siguiendo las directrices siguientes. Las máscaras de enfoque permiten controlar los tres parámetros siguientes:
   ...
   * `&op_sharpen=amount,radius,threshold`
      ...
      * `threshold` (0-255, sensibilidad del efecto.)
         ...
         Para obtener más información sobre cómo configurar estos tres parámetros, incluidas las prácticas recomendadas para su uso con el filtro, consulte [Enfoque de imágenes en Adobe Dynamic Media Classic y en el servidor de imágenes](/help/assets/s7_sharpening_images.pdf).
