---
title: Archivos XML
description: Los sitios web que utilizan un sistema basado en XML para administrar imágenes e información de imágenes pueden cargar archivos XML a Adobe Dynamic Media Classic. Obtenga más información sobre los archivos XML.
