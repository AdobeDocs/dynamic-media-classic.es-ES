---
title: Uso de la vista de detalles
seo-title: Uso de la vista de detalles
description: nulo
...
# Uso de la vista de detalles{#working-in-detail-view}
...
## Apertura de un recurso en la vista de detalles {#open-an-asset-in-detail-view}
...
1. En el panel Examinar, realice una de las siguientes acciones:
   ...
   * Seleccione el recurso y, a continuación, haga clic **en Vista de detalles**.
   * Seleccione el recurso y, a continuación, haga clic **en Archivo** &gt; **Detalles**.
...
## Obtención de información en la vista de detalles {#getting-information-in-detail-view}
...
**elementos para la publicación** Haga clic en el icono Publicar situado a la izquierda del nombre, o haga clic en Archivo &gt; Publicar o Archivo &gt; Cancelar publicación.

**Cambiar el nombre del recurso** seleccione el nombre e introducir un nuevo nombre.

**Edición y adición de metadatos** Seleccione el panel Metadatos y realice los cambios deseados. Consulte Visualización, adición y exportación de metadatos.

**Edición y adición de palabras clave** Seleccione Palabras clave y agréguelas o elimínelas según desee. Consulte Adición o edición de palabras clave.

**Elimine el recurso** haciendo clic en Archivo &gt; Eliminar.
...
|--- |--- |--- |
| Imágenes | Agregar mapas de imagen Agregar destinos de zoom Recorte Enfoque Crear vistas ajustadas | Sí; ajustes preestablecidos de zoom e imagen. |
