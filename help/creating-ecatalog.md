...
description: Aprenda a crear un catálogo electrónico.
...
1. Comience la creación del catálogo electrónico utilizando una de estas técnicas:
   ...
   * **Seleccione los archivos primero** : en el panel Examinar, seleccione archivos y, a continuación, haga clic en  **[!UICONTROL Generar]**  >  **[!UICONTROL Catálogos electrónicos]**.

   * **Comience desde la pantalla**  Catálogo electrónico: haga clic en  **[!UICONTROL Generar]**  >  **[!UICONTROL Catálogos electrónicos]**. Seleccione una carpeta en la biblioteca de recursos y arrastre los archivos deseados a la ficha Ordenar páginas que se encuentra en la página Catálogo electrónico.
...
1. Reordene las páginas según sea necesario con una de estas técnicas:
   ...
   * **Botón Mover a** : seleccione una página o un pliego de páginas, haga clic en  **[!UICONTROL Mover a]** y elija la página en el menú que desea que su página aparezca antes.
